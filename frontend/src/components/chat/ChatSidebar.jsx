...
function ChatSidebar() {
    ...
    const conversationUsers = (Array.isArray(conversations) ? conversations : []).map((user) =>
        mapUserForList(user, onlineUsers),
    );
    const allUsers = (Array.isArray(users) ? users : []).map((user) => mapUserForList(user, onlineUsers));
